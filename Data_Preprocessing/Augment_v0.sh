...
# and thus creates a dataset 16 times that of the original (including the original images)

# It was used in early iterations but was not used in any final datasets.
